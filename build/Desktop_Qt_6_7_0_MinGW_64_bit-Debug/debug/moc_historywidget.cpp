...
void HistoryWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->loadRequest((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 2: _t->backToMainMenu(); break;
        case 3: _t->deleteGame((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 4: _t->continueGame((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &HistoryWidget::backButtonClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (HistoryWidget::*)(QString );
            if (_t _q_method = &HistoryWidget::loadRequest; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void HistoryWidget::backButtonClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void HistoryWidget::loadRequest(QString _t1)
{
